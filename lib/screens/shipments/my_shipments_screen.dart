...
class _MyShipmentsScreenState extends State<MyShipmentsScreen> with SingleTickerProviderStateMixin {
  ...
  void _loadShipments({bool refresh = false}) {
    ...
    context.read<ShipmentProvider>().loadMyShipments(
    ...
    return Consumer<ShipmentProvider>(
      builder: (context, shipmentProvider, child) {
        ...
        return SmartRefresher(
          ...
          onRefresh: () async {
            await shipmentProvider.loadMyShipments(refresh: true);
            _refreshController.refreshCompleted();
          },
          onLoading: () async {
            await shipmentProvider.loadMyShipments();
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'سيتم عرض شحناتك هنا عندما تقوم بإنشاء طلب شحن',
            style: TextStyle(
              fontFamily: 'Cairo',
              fontSize: 14,
